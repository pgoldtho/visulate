...
*/
  cursor cur_prop is 
  select  rtrim(op.address1)        mail_address1		  
  ,       rtrim(op.address2)        mail_address2
  ,       rtrim(op.city)            mail_city
  ,       op.state                  mail_state
  ,       substr(op.zip_code, 1, 5) mail_zipcode
  ,       rtrim(op.owner1)          owner
  ,       op.parcel_number          
  ,       p.prop_id
