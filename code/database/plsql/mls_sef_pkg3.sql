...
*******************************************************************************/
  ...
  begin
    ...
    */
    v_select('ResidentialProperty') :=
      'sysid,22,25,61,92,93,109,113,114,115,131,135,137,146,157,165,195,214,250,264,886,891,893,1223,1465,1488,1473';
   /* Class 2 = Condos
        #Beds (25)
        Folio Number (264)
   ...
   */
    v_select('Condos') :=
      'sysid,25,59,61,92,102,109,113,114,115,131,137,157,165,180,181,195,214,261,264,347,348,886,891,893,1223,1465,1473';
    ...
    */     
    v_select('IncomeProperty') :=
      'sysid,22,61,106,113,115,131,137,157,163,165,417,191,195,214,250,261,264,404,429,444,1223,1473';
    ...
    */
    v_select('ResidentialLand') :=
     'sysid,61,90,113,115,131,137,145,157,165,184,195,214,264,318,455,462,466,467,474,475,477,478,484,485,487,495,499,500';
    ...
    */     
    ...
    'sysid,61,113,115,131,137,157,165,195,214,264,318,455,469,477,487,508,509,516,526,538,542,543,544,545,546,1223';
    ...
    */
    v_select('CommercialProperty') :=
      'sysid,61,113,115,131,137,157,165,195,214,264,318,416,510,512,514,527,533,573,616,619,632,642,643,646,647,648,651,671';
    ...
    */
    v_select('Business') :=
      'sysid,61,113,115,131,137,157,165,195,214,264,416,646,647,648,651,737,1223';
  ...
  begin
    ...
    get_listings(p_type,     'BROWARD,DADE,PALMBCH', p_mode);
