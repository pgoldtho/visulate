...
for x in (select
         ...
         RNT_SYS_CHECKSUM_REC_PKG.APPEND(x.AD_PUBLISH_YN);
         RNT_SYS_CHECKSUM_REC_PKG.APPEND(x.AD_TITLE);
         RNT_SYS_CHECKSUM_REC_PKG.APPEND(x.AD_CONTACT);
         RNT_SYS_CHECKSUM_REC_PKG.APPEND(x.AD_EMAIL);
         RNT_SYS_CHECKSUM_REC_PKG.APPEND(x.AD_PHONE);
