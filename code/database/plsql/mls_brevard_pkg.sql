...
*******************************************************************************/
  ...
  begin
    ...
    -- F=CommercialSales
    v_query('F')  := '(LIST_15=|1536QBVYCRBX)';
    -- C=LotsAndLand
  ...
  begin
     ...
     */
     ...
     /*    
          ...
          where mls_id = v_mls_id
          and rownum = 1;
          if v_photo like '%brevardpropertyappraiser%' then
            get_photos(p_prop_id, v_mls_id, p_values('LIST_1'));
          end if;
        end if;
      */
    ...
    if p_request_id is not null then
      ...
      BEGIN
        LOOP
          ...
          if v_line like 'Location:%' then
            v_line := replace(v_line, 'Location: ');
