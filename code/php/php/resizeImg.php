...
if(! defined('FILE_CACHE_DIRECTORY') )          define ('FILE_CACHE_DIRECTORY', '/thumbCache');             // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! isset($ALLOWED_SITES)){
        $ALLOWED_SITES = array (
                's3.amazonaws.com',
                'cdn.resize.flexmls.com',
                'cdn.resize.sparkplatform.com',
                'mfr.ws.marketlinx.com',
                'map.brevardpropertyappraiser.com',
                'ira.property-appraiser.org',
                'paarcgis2.ocpafl.org',
                'visulate.com'
        );
}
// -------------------------------------------------------------
