      ...
      <h3>County Sales History</h3>
       <ul class="left_menu">
         ...
         <li class="li_left_normal">
           <a class="active" href="rental/visulate_search.php?REPORT_CODE=COMMERCIAL&county={$getCounty}">
...
<tr><th scope="col">Property Class</th><th scope="col">Sales Count</th><th scope="col">Total Sales</th><th scope="col">Median Price</th></tr>
{foreach from=$data key=k item=item}
  <tr>
  <th scope="row"><a href="rental/visulate_search.php?REPORT_CODE=COMMERCIAL&CYEAR={$smarty.request.YEAR|escape:'htmlall'}&CLASS={$k}&county={$getCounty}">
