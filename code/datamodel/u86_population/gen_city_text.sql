...
declare
  ...
  procedure gen_text is
    ...
    ,      decode (r.name,
           'East Central'  , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=12">East Central Florida</a>',
           'North Central' , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=16">North Central Florida</a>',
           'North Eastern' , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=13">North Eastern Florida</a>',
           'North West'    , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=14">North West Florida</a>',
           'South Central' , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=17">South Central Florida</a>',
           'South East'    , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=10">South East Florida</a>',
           'South West'    , '<a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=15">South West Florida</a>',
           'Tampa'         , 'the <a href="/rental/visulate_search.php?REPORT_CODE=CITY&state=FL&region_id=11">Tampa Bay region of Florida</a>')  region
    ,      c.city_id
    ,      c.census_place
    from rnt_cities c
    ,    rnt_regions r
