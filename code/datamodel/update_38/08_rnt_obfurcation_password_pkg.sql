...
function encrypt(input_string varchar2) return varchar2;

function decrypt(input_string varchar2) return varchar2;
...
begin
  ...
  dbms_obfuscation_toolkit.des3encrypt(
     ...
     key_string         => rpad(X_KEY, 16, X_KEY),
