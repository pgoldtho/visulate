...
--   Script Created at  : 28.05.2007 22:15:14 
--   Physical Location  :  
--   Notes              :  
--

-- Object Counts: 
--   Packages: 16       Lines of Code: 641 
--   Package Bodies: 16 Lines of Code: 2956 


--
-- RNT_PROPERTY_EXPENSES_PKG  (Package) 
--
...
--
-- RNT_ACCOUNTS_PAYABLE_PKG  (Package) 
--
...
--
-- RNT_ACCOUNTS_RECEIVABLE_PKG  (Package) 
--
...
--
-- RNT_AGREEMENT_ACTIONS_PKG  (Package) 
--
...
--
-- RNT_PAYMENT_ALLOCATIONS_PKG  (Package) 
--
...
--
-- RNT_PROPERTY_EXPENSES_PKG  (Package Body) 
--
...
--
-- RNT_ACCOUNTS_PAYABLE_PKG  (Package Body) 
--
...
--
-- RNT_ACCOUNTS_RECEIVABLE_PKG  (Package Body) 
--
...
-------------------------------------------------
  ...
  function get_amount_for_payment(  p_payment_date DATE      -- due payment date
  ...
  begin
    ...
    for x in c_new_payment loop
      ...
      values (RNT_ACCOUNTS_RECEIVABLE_SEQ.NEXTVAL, x.NEXT_PAYMENT, x.AMOUNT,
        7, x.TENANT_ID, x.AGREEMENT_ID,
...
--
-- RNT_AGREEMENT_ACTIONS_PKG  (Package Body) 
--
...
--
-- RNT_PAYMENT_ALLOCATIONS_PKG  (Package Body) 
--
