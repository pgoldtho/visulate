...
AMOUNT_PERIOD VARCHAR2(30) NOT NULL,
...
CREDIT_LINE_YN VARCHAR2(1) NOT NULL,
ARM_YN VARCHAR2(1) NOT NULL,
BALLOON_DATE DATE,
...
RECURRING_YN VARCHAR2(1) DEFAULT 'N' NOT NULL,
RECURRING_PERIOD VARCHAR2(20) DEFAULT 'N/A',
...
(
VALUE_ID NUMBER(8, 0) NOT NULL,
NOTM NUMBER DEFAULT 1 NOT NULL,
PROPERTY_ID NUMBER NOT NULL,
VALUE_DATE DATE NOT NULL,
VALUE_METHOD VARCHAR2(30) NOT NULL,
...
NOTM NUMBER DEFAULT 1 NOT NULL,
PROPERTY_ID NUMBER NOT NULL,
UNIT_NAME VARCHAR2(32) DEFAULT 'Unit 1' NOT NULL,
UNIT_SIZE NUMBER,
BEDROOMS NUMBER,
BATHROOMS NUMBER
)
...
PAID_OR_RECEIVED VARCHAR2(16) DEFAULT 'PAID' NOT NULL,
AMOUNT NUMBER NOT NULL,
TENANT_ID NUMBER
)
;
...
VALID_VALUE VARCHAR2(80) NOT NULL,
MEANING VARCHAR2(80)
)
;

ALTER TABLE RNT_TENANCY_AGREEMENT
ADD CONSTRAINT RNT_TENANCY_AGREEMENT_PK PRIMARY KEY
(
AGREEMENT_ID
)
 ENABLE
...
ALTER TABLE RNT_TENANCY_AGREEMENT
ADD CONSTRAINT RNT_TENANCY_AGREEMENT_UK1 UNIQUE
(
UNIT_ID,
AGREEMENT_DATE
)
...
ALTER TABLE RNT_TENANT
ADD CONSTRAINT RNT_TENANT_PK PRIMARY KEY
(
TENANT_ID
)
 ENABLE
...
ALTER TABLE RNT_TENANT
ADD CONSTRAINT RNT_TENANT_UK1 UNIQUE
(
FIRST_NAME,
LAST_NAME
)
...
ADD CONSTRAINT RNT_ACCOUNTS_RECEIVABLE_PK PRIMARY KEY
(
AR_ID
)
 ENABLE
...
ADD CONSTRAINT RNT_LOANS_PK PRIMARY KEY
(
LOAN_ID
)
 ENABLE
...
ALTER TABLE RNT_LOANS
ADD CONSTRAINT RNT_LOANS_UK2 UNIQUE
(
PROPERTY_ID,
POSITION
)
...
ALTER TABLE RNT_PAYMENT_TYPES
ADD CONSTRAINT RNT_PAYMENT_TYPES_PK PRIMARY KEY
(
PAYMENT_TYPE_ID
)
 ENABLE
...
ALTER TABLE RNT_PAYMENT_TYPES
ADD CONSTRAINT RNT_PAYMENT_TYPES_UK1 UNIQUE
(
PAYMENT_TYPE_NAME
)
 ENABLE
...
ADD CONSTRAINT RNT_ACCOUNTS_PAYABLE_PK PRIMARY KEY
(
AP_ID
)
 ENABLE
...
ALTER TABLE RNT_PAYMENT_ALLOCATIONS
ADD CONSTRAINT RNT_PAYMENT_ALLOC_PK PRIMARY KEY
(
PAY_ALLOC_ID
)
 ENABLE
...
ADD CONSTRAINT RNT_PROPERTIES_PK PRIMARY KEY
(
PROPERTY_ID
)
 ENABLE
...
ALTER TABLE RNT_PROPERTIES
ADD CONSTRAINT RNT_PROPERTIES_UK1 UNIQUE
(
ADDRESS1,
ADDRESS2,
CITY,
...
ADD CONSTRAINT RNT_PROPERTY_EXPENSES_PK PRIMARY KEY
(
EXPENSE_ID
)
 ENABLE
...
ALTER TABLE RNT_PROPERTY_EXPENSES
ADD CONSTRAINT RNT_PROPERTY_HISTORY_UK1 UNIQUE
(
PROPERTY_ID,
EVENT_DATE,
UNIT_ID,
...
ADD CONSTRAINT RNT_CONTRACTORS_PK PRIMARY KEY
(
SUPPLIER_ID
)
 ENABLE
...
ALTER TABLE RNT_SUPPLIERS
ADD CONSTRAINT RNT_CONTRACTORS_UK1 UNIQUE
(
NAME
)
 ENABLE
...
ALTER TABLE RNT_PROPERTY_VALUE
ADD CONSTRAINT RNT_PROPERTY_VALUE_PK PRIMARY KEY
(
VALUE_ID
)
 ENABLE
...
ALTER TABLE RNT_PROPERTY_VALUE
ADD CONSTRAINT RNT_PROPERTY_VALUE_UK1 UNIQUE
(
PROPERTY_ID,
VALUE_DATE,
VALUE_METHOD
...
ALTER TABLE RNT_PROPERTY_UNITS
ADD CONSTRAINT RNT_PROPERTY_UNITS_PK PRIMARY KEY
(
UNIT_ID
)
 ENABLE
...
ALTER TABLE RNT_PROPERTY_UNITS
ADD CONSTRAINT RNT_PROPERTY_UNITS_UK1 UNIQUE
(
PROPERTY_ID,
UNIT_NAME
)
...
ALTER TABLE RNT_BUSINESS_UNITS
ADD CONSTRAINT RNT_BUSINESS_UNITS_PK PRIMARY KEY
(
BUSINESS_ID
)
 ENABLE
...
ALTER TABLE RNT_BUSINESS_UNITS
ADD CONSTRAINT RNT_BUSINESS_UNITS_UK1 UNIQUE
(
BUSINESS_NAME
)
 ENABLE
...
ADD CONSTRAINT RNT_PAYMENTS_PK PRIMARY KEY
(
PAYMENT_ID
)
 ENABLE
...
ALTER TABLE RNT_PAYMENTS
ADD CONSTRAINT RNT_PAYMENTS_UK1 UNIQUE
(
PAYMENT_DATE,
DESCRIPTION
)
...
ADD CONSTRAINT RNT_AGREEMENT_ACTIONS_PK PRIMARY KEY
(
ACTION_ID
)
 ENABLE
...
ALTER TABLE RNT_AGREEMENT_ACTIONS
ADD CONSTRAINT RNT_AGREEMENT_ACTIONS_UK1 UNIQUE
(
AGREEMENT_ID,
ACTION_DATE,
ACTION_TYPE
...
ALTER TABLE RNT_LOOKUPS
ADD CONSTRAINT RNT_LOOKUPS_PK PRIMARY KEY
(
TABLE_NAME,
COLUMN_NAME,
VALID_VALUE
...
ALTER TABLE RNT_TENANCY_AGREEMENT
ADD CONSTRAINT RNT_TENANCY_AGREEMENT_FK FOREIGN KEY
(
UNIT_ID
)
REFERENCES RNTMGR.RNT_PROPERTY_UNITS
(
UNIT_ID
) ENABLE
;
...
ALTER TABLE RNT_TENANT
ADD CONSTRAINT RNT_TENANT_FK FOREIGN KEY
(
AGREEMENT_ID
)
REFERENCES RNT_TENANCY_AGREEMENT
(
AGREEMENT_ID
) ENABLE
;
...
ALTER TABLE RNT_TENANT
ADD CONSTRAINT RNT_TENANT_FK2 FOREIGN KEY
(
UNIT_APPLIED_FOR
)
REFERENCES RNTMGR.RNT_PROPERTY_UNITS
...
ALTER TABLE RNT_ACCOUNTS_RECEIVABLE
ADD CONSTRAINT RNT_ACCOUNTS_RECEIVABLE_FK FOREIGN KEY
(
TENANT_ID
)
REFERENCES RNTMGR.RNT_TENANT
(
TENANT_ID
) ENABLE
;
...
ALTER TABLE RNT_ACCOUNTS_RECEIVABLE
ADD CONSTRAINT RNT_ACCOUNTS_RECEIVABLE_FK3 FOREIGN KEY
(
LOAN_ID
)
REFERENCES RNTMGR.RNT_LOANS
(
LOAN_ID
) ENABLE
;
...
ALTER TABLE RNT_ACCOUNTS_RECEIVABLE
ADD CONSTRAINT RNT_ACCOUNTS_RECEIVABLE_FK4 FOREIGN KEY
(
PAYMENT_TYPE
)
REFERENCES RNTMGR.RNT_PAYMENT_TYPES
(
PAYMENT_TYPE_ID
) ENABLE
;
...
ALTER TABLE RNT_ACCOUNTS_RECEIVABLE
ADD CONSTRAINT RNT_ACCOUNTS_RECEIVABLE_FK2 FOREIGN KEY
(
AGREEMENT_ID
)
REFERENCES RNT_TENANCY_AGREEMENT
...
ALTER TABLE RNT_LOANS
ADD CONSTRAINT RNT_LOANS_FK FOREIGN KEY
(
PROPERTY_ID
)
...
ALTER TABLE RNT_ACCOUNTS_PAYABLE
ADD CONSTRAINT RNT_ACCOUNTS_PAYABLE_FK FOREIGN KEY
(
PAYMENT_TYPE_ID
)
REFERENCES RNTMGR.RNT_PAYMENT_TYPES
...
ALTER TABLE RNT_ACCOUNTS_PAYABLE
ADD CONSTRAINT RNT_ACCOUNTS_PAYABLE_FK4 FOREIGN KEY
(
LOAN_ID
)
REFERENCES RNTMGR.RNT_LOANS
...
ALTER TABLE RNT_ACCOUNTS_PAYABLE
ADD CONSTRAINT RNT_ACCOUNTS_PAYABLE_FK1 FOREIGN KEY
(
EXPENSE_ID
)
REFERENCES RNT_PROPERTY_EXPENSES
(
EXPENSE_ID
) ENABLE
;
...
ALTER TABLE RNT_ACCOUNTS_PAYABLE
ADD CONSTRAINT RNT_ACCOUNTS_PAYABLE_FK2 FOREIGN KEY
(
SUPPLIER_ID
)
REFERENCES RNTMGR.RNT_SUPPLIERS
(
SUPPLIER_ID
) ENABLE
;
...
ALTER TABLE RNT_PAYMENT_ALLOCATIONS
ADD CONSTRAINT RNT_PAYMENTS_RNT_ACCOUNTS_FK2 FOREIGN KEY
(
AR_ID
)
...
ALTER TABLE RNT_PAYMENT_ALLOCATIONS
ADD CONSTRAINT RNT_PAYMENTS_RNT_ACCOUNTS_FK1 FOREIGN KEY
(
AP_ID
)
...
ALTER TABLE RNT_PAYMENT_ALLOCATIONS
ADD CONSTRAINT RNT_PAYMENT_ALLOCATIONS_FK FOREIGN KEY
(
PAYMENT_ID
)
REFERENCES RNT_PAYMENTS
(
PAYMENT_ID
) ENABLE
;
...
ALTER TABLE RNT_PROPERTIES
ADD CONSTRAINT RNT_PROPERTIES_FK FOREIGN KEY
(
BUSINESS_ID
)
REFERENCES RNT_BUSINESS_UNITS
(
BUSINESS_ID
) ENABLE
;
...
ALTER TABLE RNT_PROPERTY_EXPENSES
ADD CONSTRAINT RNT_PROPERTY_HISTORY_FK2 FOREIGN KEY
(
UNIT_ID
)
REFERENCES RNTMGR.RNT_PROPERTY_UNITS
...
ALTER TABLE RNT_PROPERTY_EXPENSES
ADD CONSTRAINT RNT_PROPERTY_HISTORY_FK FOREIGN KEY
(
PROPERTY_ID
)
REFERENCES RNTMGR.RNT_PROPERTIES
...
ALTER TABLE RNT_PROPERTY_VALUE
ADD CONSTRAINT RNT_PROPERTY_VALUE_FK FOREIGN KEY
(
PROPERTY_ID
)
REFERENCES RNTMGR.RNT_PROPERTIES
...
ALTER TABLE RNT_PROPERTY_UNITS
ADD CONSTRAINT RNT_PROPERTY_UNITS_FK1 FOREIGN KEY
(
PROPERTY_ID
)
REFERENCES RNTMGR.RNT_PROPERTIES
...
ALTER TABLE RNT_PAYMENTS
ADD CONSTRAINT RNT_PAYMENTS_RNT_TENANT_FK FOREIGN KEY
(
TENANT_ID
)
REFERENCES RNTMGR.RNT_TENANT
...
ALTER TABLE RNT_AGREEMENT_ACTIONS
ADD CONSTRAINT RNT_AGREEMENT_ACTIONS_FK FOREIGN KEY
(
AGREEMENT_ID
)
REFERENCES RNT_TENANCY_AGREEMENT
...
ALTER TABLE RNT_PROPERTIES
ADD CONSTRAINT RNT_PROPERTIES_CK1 CHECK
(state in ('FL', 'NC'))
 ENABLE
;
...
COMMENT ON COLUMN RNT_TENANCY_AGREEMENT.NOTM IS 'Update counter'
;
...
COMMENT ON COLUMN RNT_TENANT.NOTM IS 'Update counter'
;
...
COMMENT ON COLUMN RNT_LOANS.NOTM IS 'Update counter'
;
...
COMMENT ON COLUMN RNT_PROPERTIES.UNITS IS 'A count of the total number of rentable units in the property'
;

COMMENT ON COLUMN RNT_PROPERTIES.NOTM IS 'update counter'
;
...
COMMENT ON COLUMN RNT_PROPERTY_UNITS.NOTM IS 'Update counter'
;
...
COMMENT ON COLUMN RNT_PAYMENTS.PAID_OR_RECEIVED IS
'Does this payment releate to a payment made or an amount received?'
;
