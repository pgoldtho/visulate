...
*******************************************************************************/
  ...
  procedure update_row( X_ERROR_ID IN RNT_ERROR_DESCRIPTION.ERROR_ID%TYPE
                      ...
                      , X_DISPLAY_SHORT_DESCRIPTION_YN IN RNT_ERROR_DESCRIPTION.DISPLAY_SHORT_DESCRIPTION_YN%TYPE
  ...
  function is_show_short(x_error_code RNT_ERROR_DESCRIPTION.ERROR_CODE%TYPE) return RNT_ERROR_DESCRIPTION.DISPLAY_SHORT_DESCRIPTION_YN%TYPE;
...
-------------------------------------------------
  ...
  begin
     ...
     , DISPLAY_SHORT_DESCRIPTION_YN = X_DISPLAY_SHORT_DESCRIPTION_YN
     where ERROR_ID = X_ERROR_ID;
  ...
  begin
     ...
     , X_DISPLAY_SHORT_DESCRIPTION_YN)
...
function is_show_short(x_error_code RNT_ERROR_DESCRIPTION.ERROR_CODE%TYPE) return RNT_ERROR_DESCRIPTION.DISPLAY_SHORT_DESCRIPTION_YN%TYPE
is
  x RNT_ERROR_DESCRIPTION.DISPLAY_SHORT_DESCRIPTION_YN%TYPE;
begin
 select DISPLAY_SHORT_DESCRIPTION_YN
 into x
 from RNT_ERROR_DESCRIPTION
 where ERROR_CODE = x_error_code;
