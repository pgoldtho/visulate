...
declare
  ...
  begin
    add_rss ( p_name    => 'ANY'
            , p_county  => 'ANY'
            , p_rss     => 'http://www.miamiherald.com/news/state/florida/?widgetName=rssfeed&widgetContentId=712015&getXmlFeed=true'
    ...
    add_rss ( p_name    => 'ANY'
            , p_county  => 'MIAMI-DADE'
            , p_rss     => 'http://www.miamiherald.com/news/local/community/miami-dade/?widgetName=rssfeed&widgetContentId=712015&getXmlFeed=true'
            , p_source  => 'http://www.miamiherald.com/'
            , p_rname   => 'The Miami Herald');
    ...
    add_rss ( p_name    => 'ANY'
            , p_county  => 'BROWARD'
            , p_rss     => 'http://www.miamiherald.com/news/local/community/broward/?widgetName=rssfeed&widgetContentId=712015&getXmlFeed=true'
            , p_source  => 'http://www.miamiherald.com/'
            , p_rname   => 'The Miami Herald');
