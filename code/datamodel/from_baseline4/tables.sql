...
--   Script Created at  : 05.05.2007 8:24:08 
--   Physical Location  :  
--   Notes              :  
--

-- Object Counts: 
--   Indexes: 40        Columns: 60         
--   Tables: 22         Columns: 157        Constraints: 58     
...
--
-- RNT_SECTION8_OFFICES_PK  (Index) 
--
CREATE UNIQUE INDEX RNT_SECTION8_OFFICES_PK ON RNT_SECTION8_OFFICES
(SECTION8_ID)
LOGGING
NOPARALLEL;
...
-- RNT_PEOPLE_PK  (Index) 
--
CREATE UNIQUE INDEX RNT_PEOPLE_PK ON RNT_PEOPLE
(PEOPLE_ID)
LOGGING
NOPARALLEL;
