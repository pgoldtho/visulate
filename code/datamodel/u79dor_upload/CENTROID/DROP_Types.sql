...
declare
   ...
   v_tabs          t_tokenset := t_tokenset('MBR', 'T_ArcSet', 'T_VectorSet', 'T_Vector2DSet', 'T_Coord2DSet', 'T_ElemInfoSet', 'T_GeometrySet', 'VarChar2_Table', 'T_Arc', 'T_Vertex', 'T_Vector2D', 'T_Vector', 'T_Coord2D', 'T_ElemInfo', 'T_Geometry', 'T_Grid', 'T_WindowSet', 'ST_POINT_AGGR_TYPE', 'ST_POINTAGGR', 'ST_PointSet', 'ST_Point', 'ST_ExplicitPoint_Type', 'ST_POINT', 'ST_EXPLICITPOINT_TYPE', 'T_Error', 'T_VertexMark', 'T_TokenSet', 'T_Numbers');
begin
