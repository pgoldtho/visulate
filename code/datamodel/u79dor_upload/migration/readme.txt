create separte tablespaces for
 ...
 create RNTMGR2 schema  
 
 Export the RNTMGR schema using data pump

 
Import building and corporate data into RNTMGR2 mapping to new tablespaces
  Export production rnt and mls objects using data pump
Import mls and rnt data into RNTMGR2 mapping to new tablespaces
